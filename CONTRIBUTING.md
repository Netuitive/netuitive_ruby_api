Contributing to the Netuitive Ruby API
======================================
...
### Reporting Bugs
Report bugs on [the issues page](https://github.com/Netuitive/netuitive_ruby_api/issues).
...
### Fixing bugs
Find bugs at [the issues page](https://github.com/Netuitive/netuitive_ruby_api/issues). Anything tagged with
...
Find features at [the issues page](https://github.com/Netuitive/netuitive_ruby_api/issues). Anything tagged
...
The Netuitive Ruby API can always use documentation (more documentation is always better!). 
...
### Submitting Feedback
File an issue at [the issues page](https://github.com/Netuitive/netuitive_ruby_api/issues).
